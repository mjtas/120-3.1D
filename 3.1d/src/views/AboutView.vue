    ...
    <div class="main-container">
      <div class="other-heading">
        ...
        <div class="about-other">
          ...
          <div class="block">
            <div class="main-left">
              <h2>About Hidden Valley</h2>
              <ul class="main-text">
                <li class="main-li">Hidden Valley is a private 280 acre property bordering the Great Western Tiers Conservation Area. It has spectacular views and lies 750 metres above sea level just past the Liffey Falls turn off on Highland Lakes Road. Only 20 minutes from Deloraine and under an hour from Launceston or Devonport, it is an old grazing property with paddocks dominated by native grasses and large areas of rainforest. There are two creeks that run over the property, a waterfall, and a sandstone cave.</li>
              </ul>
            </div>
          <div class="main-right">
            <div class="main-opaque">
              <img class="about-img" src="../assets/hiddenValley.png" alt="Hidden Valley">
            </div>
          </div>
        </div>
      </div>
